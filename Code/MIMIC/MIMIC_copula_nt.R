...
##### - Functions - #####
source("/Users/nakashimatakaya/Desktop/Simulation_study/code/copula_vps-main/scripts/functions/estimate_vinecopula_from_data.R")
source("/Users/nakashimatakaya/Desktop/Simulation_study/code/copula_vps-main/scripts/functions/functions.R")
source("/Users/nakashimatakaya/Desktop/Simulation_study/code/copula_vps-main/scripts/functions/plot_distributions.R")


##### - Data - #####
#Load and clean data
## labs cvh.csv←このデータはない
# load("/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/data_wide_127vars.Rdata")
...
#save cleaned data
save(cop_data_MIMIC, file = "/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/data_copula_mimic_clean.Rdata")
...
#explore copula
load("/Users/nakashimatakaya/Desktop/Simulation_study/code/copula_vps-main/copulas/mimic_copula.Rdata") #cop_mimic
load("/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/data_copula_mimic_clean.Rdata") #cop_data_MIMIC
...
pdf(file = "/Users/nakashimatakaya/Desktop/Simulation_study/Outcome/MIMIC/F5_six_densities_MIMIC.pdf", width = 0.85*9, height = 0.85*6)
...
median(performance_data$rel_value,na.rm = TRUE)
