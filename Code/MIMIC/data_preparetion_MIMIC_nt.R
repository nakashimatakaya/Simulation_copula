...
# 実データは3億行あるのでダウンロードは無理．
reduced_chartevents <- fread("/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/chartevents.csv")
#reduced_chartevents <- icu.chartevents[, c(1, 4, 6, 7)]
rm(icu.chartevents)

core.patient <- fread("/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/patients.csv")

icu.chartevents_weight <- fread("/Users/nakashimatakaya/Desktop/Simulation_study/code/copula_vps-main/data/MIMIC/reduced/icu_chartevents_weight.csv") #from data_reduction.py

icu.d_items <- fread("/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/d_items.csv")

##### - Data preparation - #####
icu.chartevents_weight_first <- icu.chartevents_weight %>% 
  group_by(subject_id) %>% 
...
total_data <- core.patient %>% 
  left_join(icu.chartevents_weight_first, "subject_id")
...
save(reduced_rows4, file = "/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/data_wide_127vars.Rdata")
...
save(information, file = "/Users/nakashimatakaya/Desktop/Simulation_study/Data/MIMIC/information.Rdata")
